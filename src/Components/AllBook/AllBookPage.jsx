                ...
                <div className="flex-1 flex justify-start items-center ml-4 p-2">
                    <div className='space-y-2'>
                        ...
                        <div className="card-actions mt-4">
                            <Link><button className="flex gap-2 items-center bg-slate-300 rounded-3xl px-3 py-2 text-blue-900 font-medium">Update <FaArrowRight></FaArrowRight></button></Link>
                        </div>
                    </div>
                </div>
            </div>
