...
const BorrowedBookCard = ({ books }) => {
    const { email, image, bookName, category, returnDate, borrowedDate } = books;
    return (
        <div>
            <div className="card lg:card-side bg-base-100 shadow-xl mt-4">
                ...
                <div className="card-body">
                    ...
                    <div className="card-actions justify-end">
                        <button className="btn btn-outline btn-success">Return Book</button>
                    </div>
                </div>
            </div>
        </div>
